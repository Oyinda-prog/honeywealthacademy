    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-white shadow-md border-r p-6 space-y-6">
        ...
        <nav className="space-y-3">
          ...
          <Link href="/account/test" className="block text-gray-700 hover:text-blue-900">📝 Write Test</Link>
          <Link href="/account/view_personalinformation" className="block text-gray-700 hover:text-blue-900">👤 Personal Information</Link>
